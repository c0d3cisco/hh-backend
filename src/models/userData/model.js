...
const userModel = (sequelize, DataTypes) =>{
  ...
  const model = sequelize.define('userData', {
    ...
    q22: { type: DataTypes.ENUM(['1 - Terrible', '5 - Excellent']), required: false }, // On a scale of 1-5, how do you feel your life is going most of the time? (Please circle one):
    q23: { type: DataTypes.ENUM(['1 - No Support', '5 - Excellent Support']), required: false }, // ON a scale of 1-5, how much support do you feel you currently have? (Please circle one):
